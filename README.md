...
##### Chaelynn:
This final project for HCDE 438 grew my web development skills in terms of technical knowledge. It was my first time using React and Node.js, and it helped me understand how useful component-based development is for keeping the frontend organized and scalable. This will be useful when I take on more front-end code projects in the future.  I also learned Firebase and Firestore for the first time, which showed me how to store and manage user data in real time and build more interactive features for future web application projects. 
It was also my first time collaborating with a partner on a coding project. I didn’t realize the importance of overcommunication until we ran into issues with pulling and pushing changes. Still, Lorelai and I worked really well together, and we fixed major bugs on time and met the technical requirements. If I were to do this project again, I’d build a better timeline with buffer periods for unexpected errors. When our API implementation code ran into CORS-related problems, we had to shift our focus away from styling to functionality, which made our early CSS less user-friendly than we wanted. We improved it later, but better planning would’ve helped significantly. 
